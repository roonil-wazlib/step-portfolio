...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeesNotEnforced() {
    // C has an all day event but is an optional attendee. We should see three options because A and B
    // split the restricted times, and C need not attend.
    //
    // Events  :       |--A--|     |--B--|
    // Optional: |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void includeOptionalIfPossible() {
    // Have each person have different non-overlapping events, including an optional attendee. 
    // We should see two options because it is possible for the optional person to attend.
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  public void justEnoughRoomWithoutOptional() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting if and only if an optional attendee B is excluded.
    //
    // Events  : |--A--|     |----A----|
    //                 |-B-|
    // Day     : |---------------------|
  ...
  public void noMandatoryAttendees() {
    // 2 optional attendees with multiple gaps in schedules.
    //
    // Events  : |-A-|         |-A-|
    //                  |-B-|  |-B-|
    // Day     : |---------------------|
  ...
  @Test
  public void allOptionalAndNotFree() {
    // 2 optional attendees with no gaps in schedules. Should show whole day as available
    // because the optional attendees can't make it and all 0 mandatory attendees are free
    // all day.
    //
    // Events  : |----------A----------|       
    //           |----------B----------|   
